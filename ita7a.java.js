        ...
        <div class="uzr fl corner borderg mm" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
          ...
          <div class="uzr fl" style="padding:0px;width:80%">
            <div style="padding:0px;width:100%;" class="fl">
              ...
              <span style="padding: 1px 8px; margin-top: 2px; display: block; max-width: 82%; border-radius: 3px; color: rgb(199, 103, 48);" class="corner nosel u-topic dots fl hand">â€ژ    Java ط¬ظ€ط§ظپظ€ط¢ âœھ	  </span>
            </div>
            <br>
            <div style="padding: 0px; width: 100%; color: rgb(60, 0, 255);" class=" u-msg   break  fl">
            <div style="padding: 0px;width: 100%;color: rgb(60, 0, 255);text-align: left;display: block;margin-top: -17px;" class=" u-msg   break  fl"> ظ…ط±ط­ط¨ط§ظ‹ ط¨ظƒ  <h1 style="display: inline-block;color: red;">`+ getuser(myid).topic+ `</h1> ظ†ظ‚ط¯ظ‘ط± طھظˆط§ط¬ط¯ظƒ ظ…ط¹ظ†ط§طŒ ظˆظ†طھظ…ظ†ظ‰ ظ„ظƒ ظٹظˆظ…ط§ظ‹ ط³ط¹ظٹط¯ط§ظ‹ ط¥ظ† ط´ط§ط، ط§ظ„ظ„ظ‡ </div>
          </div>
        </div></div>
    `).appendTo('div#d2')
    clearInterval(myVar);
